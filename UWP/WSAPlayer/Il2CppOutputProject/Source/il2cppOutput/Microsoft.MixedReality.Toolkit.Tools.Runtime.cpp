...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Enum_TryParse_TisInt32Enum_t6312CE4586C17FE2E2E513D2E7655B574F10FDCD_m423C00452933DDD5D455C4709C7A937A89CCFBA1_gshared (String_t* p0, int32_t* p1, const RuntimeMethod* method);
...
IL_002d:
	{
		...
		float L_12 = Input_GetAxis_mF334BDB532DF82E30273ABA0ACB5116AC8244496(L_11, /*hidden argument*/NULL);
		float L_13 = L_12;
...
IL_006d:
	...
	}
	{
		...
		int32_t L_25 = V_1;
		bool L_26 = Input_GetKey_m54DC93F781FFEAB1DCDFAA3D15FA2FC01BF7667A(L_25, /*hidden argument*/NULL);
		bool L_27 = L_26;
...
IL_00ce:
	{
		...
		float L_35 = Input_GetAxis_mF334BDB532DF82E30273ABA0ACB5116AC8244496(L_34, /*hidden argument*/NULL);
		V_3 = L_35;
		// if (reading != 0.0)
		float L_36 = V_3;
...
IL_012b:
	...
	}
	{
		...
		int32_t L_55 = V_5;
		bool L_56 = Input_GetKey_m54DC93F781FFEAB1DCDFAA3D15FA2FC01BF7667A(L_55, /*hidden argument*/NULL);
		V_6 = L_56;
		// if (isPressed)
		bool L_57 = V_6;
		if (!L_57)
