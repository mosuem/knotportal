...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityPlayspace_AddChild_mA137BA9496C5D73FC8DB4F4C2F3E7BD09BAAEBC4 (Transform_tBB9E78A2766C3C83599A8F66EDE7D1FCAFC66EDA * p0, const RuntimeMethod* method);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  MixedRealityPlayspace_InverseTransformPoint_m454BFC64F823A342B54A6520B8B8F01BC611FDE3 (Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  p0, const RuntimeMethod* method);
// !0 System.Nullable`1<System.Single>::get_Value()
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  MixedRealityPlayspace_TransformPoint_m0DB731A4C7C7B1B716BACC877D80EEC8BE5CD493 (Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  p0, const RuntimeMethod* method);
...
IL_0025:
	{
		...
		NullCheck(L_7);
		float L_8 = MixedRealityBoundaryVisualizationProfile_get_BoundaryHeight_m4DE8D963EBA053195FAFEBE642879AC10F2D566A(L_7, /*hidden argument*/NULL);
		MixedRealityBoundarySystem_set_BoundaryHeight_mF7971C72E3AFFE1BB66D6FA286C6BEB077F9F9BB(__this, L_8, /*hidden argument*/NULL);
		// SetTrackingSpace();
		...
		NullCheck(L_9);
		bool L_10 = MixedRealityBoundaryVisualizationProfile_get_ShowFloor_mA17EE8C7A466FA76307F85463F49382181FEF06C(L_9, /*hidden argument*/NULL);
		...
		NullCheck(L_11);
		int32_t L_12 = MixedRealityBoundaryVisualizationProfile_get_FloorPhysicsLayer_m3D69199B416FB5AC382784E37925789A49EB4280(L_11, /*hidden argument*/NULL);
		...
		NullCheck(L_13);
		bool L_14 = MixedRealityBoundaryVisualizationProfile_get_ShowPlayArea_m641659688C7BCFA11580F82C015F85BC3CB30F40(L_13, /*hidden argument*/NULL);
		...
		NullCheck(L_15);
		int32_t L_16 = MixedRealityBoundaryVisualizationProfile_get_PlayAreaPhysicsLayer_mBE2E6A70E77B16B048FC86481E4314580E197C1E(L_15, /*hidden argument*/NULL);
		...
		NullCheck(L_17);
		bool L_18 = MixedRealityBoundaryVisualizationProfile_get_ShowTrackedArea_mEDBAAEA39E9753FEFEDFB152A38BCB727F634DFC(L_17, /*hidden argument*/NULL);
		...
		NullCheck(L_19);
		int32_t L_20 = MixedRealityBoundaryVisualizationProfile_get_TrackedAreaPhysicsLayer_mCDE1FE63A5F12501888641279E3DE8C2D2F987EB(L_19, /*hidden argument*/NULL);
		...
		NullCheck(L_21);
		bool L_22 = MixedRealityBoundaryVisualizationProfile_get_ShowBoundaryWalls_m9F9D8AA0BB46919E74D350623BEAF1F6AE397FB7(L_21, /*hidden argument*/NULL);
		...
		NullCheck(L_23);
		int32_t L_24 = MixedRealityBoundaryVisualizationProfile_get_BoundaryWallsPhysicsLayer_m079B9999CDD6CFB9E277F766DAEB9B687BF49BCD(L_23, /*hidden argument*/NULL);
		...
		NullCheck(L_25);
		bool L_26 = MixedRealityBoundaryVisualizationProfile_get_ShowBoundaryCeiling_m61668A5B1CB116F425A56F91DA4FB17EF0DFCA3B(L_25, /*hidden argument*/NULL);
		...
		NullCheck(L_27);
		int32_t L_28 = MixedRealityBoundaryVisualizationProfile_get_CeilingPhysicsLayer_m9DAE5F0110D8F027B7E3E591F9FB0D55E663139B(L_27, /*hidden argument*/NULL);
		...
		// if (ShowFloor)
		bool L_29 = MixedRealityBoundarySystem_get_ShowFloor_m152A00A23647B3C7DFB092D20B6E0D7A6A2EE109(__this, /*hidden argument*/NULL);
		if (!L_29)
		{
			goto IL_00da;
		}
...
IL_00da:
	{
		// if (ShowPlayArea)
		bool L_30 = MixedRealityBoundarySystem_get_ShowPlayArea_m3CD09D1DDCEACE34736BB7325854AD5234795056(__this, /*hidden argument*/NULL);
		if (!L_30)
		{
			goto IL_00e9;
		}
...
IL_00e9:
	{
		// if (ShowTrackedArea)
		bool L_31 = MixedRealityBoundarySystem_get_ShowTrackedArea_mA4D9485F9A8201E554DFED1800006667442961A3(__this, /*hidden argument*/NULL);
		if (!L_31)
		{
			goto IL_00f8;
		}
...
IL_0107:
	{
		// if (ShowBoundaryWalls)
		bool L_33 = MixedRealityBoundarySystem_get_ShowBoundaryWalls_m64D2B7D72151B7E2EF0E0471950CC06C816986D1(__this, /*hidden argument*/NULL);
		if (!L_33)
		{
			goto IL_0116;
		}
...
IL_0021:
	...
	{
		float L_11 = MixedRealityBoundarySystem_get_BoundaryHeight_m0E39F63F2595C6331DD291627DD6C8C9E5D2E8B6(__this, /*hidden argument*/NULL);
...
IL_0038:
	{
		...
		NullCheck(L_8);
		Vector2_tA85D2DD88578276CA8A8796756458277E72D073D  L_9 = InscribedRectangle_get_Center_mF4A04C9BD5B63590AEA784EDF53E508800CBC4E0(L_8, /*hidden argument*/NULL);
		float L_10 = L_9.get_x_0();
		InscribedRectangle_t8D747B0F1FE1A859B01F64D198D4C55E1B9E77CE * L_11 = __this->get_rectangularBounds_37();
		NullCheck(L_11);
		Vector2_tA85D2DD88578276CA8A8796756458277E72D073D  L_12 = InscribedRectangle_get_Center_mF4A04C9BD5B63590AEA784EDF53E508800CBC4E0(L_11, /*hidden argument*/NULL);
		...
		*(Vector2_tA85D2DD88578276CA8A8796756458277E72D073D *)L_16 = L_21;
		...
		NullCheck(L_23);
		float L_24 = InscribedRectangle_get_Angle_m7BC2F288965CD2B5ABBE714DEE7BC6FC89B5DFDF(L_23, /*hidden argument*/NULL);
		*((float*)L_22) = (float)L_24;
		...
		NullCheck(L_26);
		float L_27 = InscribedRectangle_get_Width_m92296BC623C43A04D35163E40231C0EE849DD634(L_26, /*hidden argument*/NULL);
		*((float*)L_25) = (float)L_27;
		...
		NullCheck(L_29);
		float L_30 = InscribedRectangle_get_Height_m2416AF303DEAA152859F090920EE50B907191EB8(L_29, /*hidden argument*/NULL);
...
IL_0047:
	{
		...
		Nullable_1_t96A9DB0CC70D8F236B20E8A1F00B8FE74850F777  L_24 = MixedRealityBoundarySystem_get_FloorHeight_m9073F4C9C3DE8CCAFA39455828D079DB629DEBF5(__this, /*hidden argument*/NULL);
		V_2 = L_24;
		...
		NullCheck(L_37);
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_38 = MixedRealityBoundaryVisualizationProfile_get_FloorMaterial_m381AC89071424F42A28A34B715CE2732C86B8097(L_37, /*hidden argument*/NULL);
		NullCheck(L_36);
...
IL_008a:
	...
	}
	{
		...
		NullCheck(L_41);
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_42 = MixedRealityBoundaryVisualizationProfile_get_TrackedAreaMaterial_m6F5D24B5B06A17FB71D3EB531C7FFAEC8E3B7006(L_41, /*hidden argument*/NULL);
		NullCheck(L_40);
...
IL_009f:
	...
	}
	{
		...
		MixedRealityBoundarySystem_set_FloorHeight_m4CE0DDE778F733E3AE8A18CCF0226EE28F9250C6(__this, L_32, /*hidden argument*/NULL);
		...
		MixedRealityBoundarySystem_set_Bounds_m7F30A1FD9A12AD83BE5F5712DCFA32FCB46466FE(__this, L_34, /*hidden argument*/NULL);
