            ...
            for (int i = 0; i < textInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debugger.Log("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debugger.Log("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Debugger.Log(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
